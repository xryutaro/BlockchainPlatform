...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Blockchain processing");
    
    let mut processor = BlockchainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockchainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockchainProcessor::new(false);
